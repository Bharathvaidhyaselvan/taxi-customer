...
export const app_name = "Fast Taxi";
export const base_url = "https://fasttaxi.co.in/";
export const api_url = "https://fasttaxi.co.in/api/";
export const img_url = "https://fasttaxi.co.in/public/uploads/";
...
//Map 
export const GOOGLE_KEY = "AIzaSyBtat61DMoI-fb18t3RuAi5l0RAe-OiIk0";
...
export const car = require(".././assets/img/car.gif");
...
export const search_new = require(".././assets/json/search_new.json");
