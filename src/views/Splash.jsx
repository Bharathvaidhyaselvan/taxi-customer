        ...
        .then(async data => {
          try {
            const granted = await PermissionsAndroid.request(
              ...
              'message': app_name + ' needs to Access your location for show nearest taxi'
            }
            )
    ...
    await axios({
      ...
      .then(async response => {
        if(response.data.result.android_latest_version.version_code > app_version_code){
          navigate_update_app('https://play.google.com/store/apps/details?id=com.fast_taxi_customer.customer');
        }else{
