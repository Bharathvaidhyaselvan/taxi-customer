...
import { screenHeight, screenWidth, normal, bold, api_url, get_bill, regular, app_name, send_invoice, f_25, f_s, f_xs, f_m } from '../config/Constants';
    ...
    const call_invoice = () => {
        ...
        .then(async response => {
            ...
            if(response.data.status == 1){
                alert("Invoice sent to your mail id")
            }
        })
        .catch(error => {
            setLoading(false);
                        ...
                        <View>
                            ...
                            <View style={{ padding: 20 }}>
                                ...
                                <View style={{ flexDirection:'row', alignItems: 'center', justifyContent: 'center', width:'100%'}}>
                                    ...
                                    <View style={{ alignItems: 'center', justifyContent: 'center', width:'50%' }}>
                                        <TouchableOpacity onPress={call_invoice.bind(this)} activeOpacity={1} style={{ flexDirection: 'row', borderWidth: 0.5, borderRadius: 10, height: 45, alignItems: 'center', justifyContent: 'center', padding: 10 }}>
                                            <Icon type={Icons.AntDesign} name="mail" color={colors.theme_fg_two} style={{ fontSize: 20 }} />
                                            <View style={{ margin: 5 }} />
                                            <Text style={{ color: colors.theme_fg_two, fontSize: f_s, color: colors.theme_fg_two, fontFamily: bold }}>Invoice</Text>
                                        </TouchableOpacity>
                                    </View>
                                </View>
                            </View>
