...
import { api_url, register, normal, bold, regular, f_xl, f_xs, f_m } from '../config/Constants';
...
const CreatePassword = (props) => {
    ...
    const call_register = async () => {
        console.log({ fcm_token: global.fcm_token, phone_number: props.phone_number, phone_with_code: props.phone_with_code, country_code: props.country_code, first_name: props.first_name, last_name: props.last_name, email: props.email, password: password, referral_code: '' })
        Keyboard.dismiss();
        setLoading(true);
        await axios({
            method: 'post',
